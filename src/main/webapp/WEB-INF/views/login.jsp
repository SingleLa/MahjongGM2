...
<head>
  ...
  <title>后台登陆页面 Bootstrap响应式后台管理系统模版Mac - 代码家园-www.daimajiayuan.com</title> 
        ...
        <!-- Widget starts -->
            <div class="widget worange">
              ...
              <div class="widget-content">
                <div class="padd">
                  <!-- Login form -->
                  <form action="<%=basePath %>login.do" method="post" class="form-horizontal">
                    <!-- Email -->
                    <div class="form-group">
                      <label class="control-label col-lg-3" for="inputPassword">用户名</label>
                      <div class="col-lg-9">
                        <input type="text" class="form-control" id="inputPassword" name = "userName" placeholder="用户名">
                      </div>
                    </div>
                    <!-- Password -->
                    <div class="form-group">
